...
// fs.readFile(path.join(__dirname,'prac' , 'rev1.txt'),'utf8' ,
// (err,data) => {
//   if (err) throw err;
...
//     fs.writeFile(path.join(__dirname,'prac' , 'addprac.txt'),"welcome to the dreamland" ,
//     (err) => {
//       if (err) throw err;
...
//       fs.readFile(path.join(__dirname,'prac' , 'addprac.txt'),'utf8' ,
//       (err,data) => {
//         if (err) throw err;
